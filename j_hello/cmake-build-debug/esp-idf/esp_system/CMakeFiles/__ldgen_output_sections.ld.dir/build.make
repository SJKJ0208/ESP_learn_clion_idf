...
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_system/ld/esp32/sections.ld.in
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_ringbuf/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/driver/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_pm/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/spi_flash/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_gdbstub/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/espcoredump/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_phy/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_system/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_system/app.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/hal/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_event/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_wifi/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/lwip/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/log/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/heap/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/soc/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_hw_support/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/xtensa/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_common/common.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/esp_common/soc.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/freertos/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/newlib/newlib.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/newlib/system_libs.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/app_trace/linker.lf
esp-idf/esp_system/ld/sections.ld: G:/IDF/esp-idf-v4.4/components/bt/linker.lf
...
esp-idf/esp_system/ld/sections.ld: G:/IDF/pro/j_hello/sdkconfig
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=G:\IDF\pro\j_hello\cmake-build-debug\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating ld/sections.ld"
	cd /d G:\IDF\pro\j_hello\cmake-build-debug\esp-idf\esp_system && python G:/IDF/esp-idf-v4.4/tools/ldgen/ldgen.py --config G:/IDF/pro/j_hello/sdkconfig --fragments G:/IDF/esp-idf-v4.4/components/esp_ringbuf/linker.lf	G:/IDF/esp-idf-v4.4/components/driver/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_pm/linker.lf	G:/IDF/esp-idf-v4.4/components/spi_flash/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_gdbstub/linker.lf	G:/IDF/esp-idf-v4.4/components/espcoredump/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_phy/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_system/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_system/app.lf	G:/IDF/esp-idf-v4.4/components/hal/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_event/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_wifi/linker.lf	G:/IDF/esp-idf-v4.4/components/lwip/linker.lf	G:/IDF/esp-idf-v4.4/components/log/linker.lf	G:/IDF/esp-idf-v4.4/components/heap/linker.lf	G:/IDF/esp-idf-v4.4/components/soc/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_hw_support/linker.lf	G:/IDF/esp-idf-v4.4/components/xtensa/linker.lf	G:/IDF/esp-idf-v4.4/components/esp_common/common.lf	G:/IDF/esp-idf-v4.4/components/esp_common/soc.lf	G:/IDF/esp-idf-v4.4/components/freertos/linker.lf	G:/IDF/esp-idf-v4.4/components/newlib/newlib.lf	G:/IDF/esp-idf-v4.4/components/newlib/system_libs.lf	G:/IDF/esp-idf-v4.4/components/app_trace/linker.lf	G:/IDF/esp-idf-v4.4/components/bt/linker.lf --input G:/IDF/esp-idf-v4.4/components/esp_system/ld/esp32/sections.ld.in --output G:/IDF/pro/j_hello/cmake-build-debug/esp-idf/esp_system/ld/sections.ld --kconfig G:/IDF/esp-idf-v4.4/Kconfig --env-file G:/IDF/pro/j_hello/cmake-build-debug/config.env --libraries-file G:/IDF/pro/j_hello/cmake-build-debug/ldgen_libraries --objdump "C:/Program Files/CodeBlocks/MinGW/bin/objdump.exe"
...
esp-idf/esp_system/CMakeFiles/__ldgen_output_sections.ld.dir/clean:
	cd /d G:\IDF\pro\j_hello\cmake-build-debug\esp-idf\esp_system && $(CMAKE_COMMAND) -P CMakeFiles\__ldgen_output_sections.ld.dir\cmake_clean.cmake
